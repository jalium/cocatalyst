...
## R script
The R script used to visualize the metabolic data is shown [here](https://github.com/jalium/cocatalyst/blob/master/metabolic.R) with the respective outputs displayed in [Rmarkdown](https://github.com/jalium/cocatalyst/blob/master/metabolic.md).
